...
For this course, we will use **CUDA 12.8** to support program compilation and execution. This is the system-default version of CUDA and you do not need to do anythign to enable it. 
